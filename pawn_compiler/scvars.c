...
SC_VDEFINE char lstfname[_MAX_PATH];        /* preprocessor listing file name */
SC_VDEFINE char asmfname[_MAX_PATH];        /* intermediate (assembler) file name */
...
SC_VDEFINE int sc_lstfile= FALSE;  /* create .LST file? */
...
SC_VDEFINE FILE *lstf    = NULL;   /* lst file */
SC_VDEFINE FILE *asmf    = NULL;   /* asm file */
