 ...
 *  under the License.
 *
 *  Version: $Id: sc6.c 4541 2011-07-21 12:15:13Z thiadmer $
 */
#include <assert.h>
#include <stdio.h>
...
static cell do_case_ovl(FILE *fbin,const char *params,cell opcode,cell cip)
{
...
static OPCODE opcodelist[] = {
  ...
  {  0, NULL,          0,        noop,     0 },
  /* opcodes in alphabetically sorted order */
  ...
  {  0, "case.ovl",    sIN_CSEG, do_case_ovl, 1 },
